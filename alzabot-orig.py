...
'''
python alzabot.py --name="GIGABYTE GeForce RTX 3060 Ti EAGLE OC 8G"
'''

base_url = 'https://www.alza.cz/graficke-karty-nvidia-geforce-rtx-3060-ti/18884150.htm'
...
def get_product_links():
    ...
    print('Stranka', r.html)
    print('Stranka obsah', r.text)
    items = r.html.find('boxes', first=True)
    print('Seznam', items)
